...
const FAQ: Record<string, string> = {
  حجز: "يمكنك الحجز عبر زر 'احجز الآن' في صفحة كل فندق، أو تواصل معنا مباشرة عبر الواتساب 📲",
  مواعيد: "يستمر الإفطار من 6:30 ص حتى 10:30 ص في أيام الإسبوع، ومن 7:00 ص حتى 11:30 ص في الإجازات 🌅",
  فطور: "يستمر الإفطار من 6:30 ص حتى 10:30 ص في أيام الإسبوع، ومن 7:00 ص حتى 11:30 ص في الإجازات 🌅",
  ...
  غرف: "نقدم مجموعة متنوعة من الغرف: غرف ديلوكس، سوبيريور، وأجنحة فاخرة. تفضل بزيارة صفحة الفندق للتفاصيل 🛏️",
  خدمة: "خدمة الغرف متاحة على مدار الساعة في جميع فنادقنا 🛎️",
  غادي: "غادي للشقق المخدومة توفر شققاً مجهزة بالكامل مثالية للإقامات الطويلة والعائلات 🏠",
  رويال: "فندق سكناي رويال يقع في قلب الرياض ويقدم تجربة إقامة ملكية فاخرة من 5 نجوم 👑",
  عقيق: "فندق سكناي العقيق في المدينة المنورة قريب من المسجد النبوي الشريف ⭐",
  منتجع: "منتجع سكناي في أبها يمنحك تجربة طبيعية خلابة في أجواء جبلية رائعة 🏔️",
  أياس: "فندق أياس في جدة يقع على كورنيش جدة ويقدم إطلالات بحرية رائعة 🌊",
  اتصال: "يمكنك التواصل معنا على الرقم المركزي +966500000000 📞",
  تواصل: "يمكنك التواصل معنا عبر الواتساب أو الاتصال المباشر +966500000000 📞",
  هلا: "هلاً وسهلاً! كيف يمكنني مساعدتك اليوم؟ 😊",
  مرحبا: "مرحباً! أنا سالم، مساعدك الذكي في مجموعة سكناي. كيف أقدر أساعدك؟ 🌟",
  اسعار: "للاطلاع على أفضل الأسعار وتوافر الغرف، يرجى زيارة صفحة الحجز أو التواصل معنا مباشرة 💰",
  سعر: "للاطلاع على الأسعار، يرجى زيارة صفحة الحجز أو التواصل معنا على الواتساب 💰",
};
...
function getBotReply(input: string): string {
  ...
  return "شكراً لسؤالك! يسعدني مساعدتك. للحصول على إجابة دقيقة، تواصل مع فريقنا عبر الواتساب أو اتصل بنا على +966500000000 🙏";
}
      ...
      <AnimatePresence>
        {!open && (
          <motion.div
            ...
            className="fixed bottom-[4.5rem] left-[4.5rem] z-50 bg-[#0d1b2a] text-white text-xs px-3 py-1.5 rounded-full shadow-lg border border-[#c8a951]/30 whitespace-nowrap pointer-events-none"
          >
            سالم AI ✨
          </motion.div>
        )}
